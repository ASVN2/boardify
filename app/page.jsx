    ...
    <>
      <div className="max-w-[1200px] mx-auto px-2">
        ...
        <div className="store my-20">
          ...
          <div className="flex gap-4 xl:flex-nowrap flex-wrap-reverse">
            <img className="rounded-md w-full" src="https://www.blogto.com/listings/fashion/upload/2011/07/20110705-sanction-9.jpg" alt="image-13" />
            <img className="rounded-md w-full" src="https://www.blogto.com/listings/fashion/upload/2011/07/20110705-sanction-1.jpg" alt="image-14" />
          </div>
        </div>
        <ListPodact data={data} title={'Our Pupler Pordact'} start={6} end={10} />
        <div className="choose flex-col-reverse md:flex-row xl:flex-row lg:flex-row flex gap-4 justify-between my-20 text-white bg-[#1d1f20] p-6 rounded-lg place-items-center">
          <div className="text">
